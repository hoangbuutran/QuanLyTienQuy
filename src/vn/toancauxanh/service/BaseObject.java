...
public class BaseObject<T> extends CoreObject<T> {
	...
	@Command
	public void refreshList(@BindingParam("ten") @Default(value = "") final String ten,
			@BindingParam("notify") Object beanObject, @BindingParam("attr") @Default(value = "*") String fields) {
		invoke(null, ten, null, beanObject, fields, null, false);
	}
	...
	@Transient
	public final Map<String, String> getTrangThaiListAndNullQuy() {
		HashMap<String, String> result = new HashMap<>();
		result.put(null, "");
		result.put("false", "Đã nộp đủ");
		result.put("true", "Chưa nộp đủ");
		return result;
	}
	...
	public List<Double> getAllTienQuyMacDinh(){
		List<Double> list = new ArrayList<Double>();
		list.add((double) 5000);
		list.add((double) 10000);
		list.add((double) 15000);
		list.add((double) 20000);
		list.add((double) 25000);
		list.add((double) 30000);
		list.add((double) 35000);
		list.add((double) 40000);
		list.add((double) 45000);
		list.add((double) 50000);
		list.add((double) 55000);
		list.add((double) 60000);
		list.add((double) 65000);
		list.add((double) 70000);
		list.add((double) 75000);
		list.add((double) 80000);
		list.add((double) 85000);
		list.add((double) 90000);
		list.add((double) 95000);
		list.add((double) 100000);
