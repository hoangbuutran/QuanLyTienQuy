...
public final class NhanVienService extends BasicService<NhanVien> {
	...
	private List<NhanVien> nhanViensTimKiem = new ArrayList<>();

	public List<NhanVien> getNhanViensTimKiem() {
		if (nhanViensTimKiem.size() == 0) {
			nhanViensTimKiem = getTacGiasAndNull();
		}
		return nhanViensTimKiem;
	}
