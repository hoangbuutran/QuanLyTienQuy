...
public class Entry extends BaseObject<Object> {
	...
	@Value("${url.lydothu}" + ":" + "${action.them}")
	public String LYDOTHUTHEM = "";
	@Value("${url.lydothu}" + ":" + "${action.list}")
	public String LYDOTHULIST = "";
	@Value("${url.lydothu}" + ":" + "${action.xoa}")
	public String LYDOTHUXOA = "";
	@Value("${url.lydothu}" + ":" + "${action.sua}")
	public String LYDOTHUSUA = "";
	
	@Value("${url.thutien}" + ":" + "${action.xem}")
	public String THUTIENXEM = "";
	@Value("${url.thutien}" + ":" + "${action.them}")
	public String THUTIENTHEM = "";
	@Value("${url.thutien}" + ":" + "${action.list}")
	public String THUTIENLIST = "";
	@Value("${url.thutien}" + ":" + "${action.xoa}")
	public String THUTIENXOA = "";
	@Value("${url.thutien}" + ":" + "${action.sua}")
	public String THUTIENSUA = "";
	
	@Value("${url.phieuchi}" + ":" + "${action.xem}")
	public String PHIEUCHIXEM = "";
	@Value("${url.phieuchi}" + ":" + "${action.them}")
	public String PHIEUCHITHEM = "";
	@Value("${url.phieuchi}" + ":" + "${action.list}")
	public String PHIEUCHILIST = "";
	@Value("${url.phieuchi}" + ":" + "${action.xoa}")
	public String PHIEUCHIXOA = "";
	@Value("${url.phieuchi}" + ":" + "${action.sua}")
	public String PHIEUCHISUA = "";

	@Value("${url.thongke}" + ":" + "${action.xem}")
	public String THONGKEXEM = "";
	...
	public final ThuTienService getThuTiens(){
		return new ThuTienService();
	}
	
	public final PhieuChiService getPhieuChis(){
		return new PhieuChiService();
	}

	public final ChiTietPhieuChiService getChiTietPhieuChis() {
		return new ChiTietPhieuChiService();
	}
