...
public class VaiTro extends Model<VaiTro> {
	...
	public Set<String> getQuyenAllMacDinhs() {
		...
		quyens1.add(core().TODAIBIEUTHEM);
		quyens1.add(core().TODAIBIEUSUA);
		quyens1.add(core().TODAIBIEUXEM);
		quyens1.add(core().TODAIBIEULIST);
		quyens1.add(core().TODAIBIEUXOA);
		...
		quyens1.add(core().THUTIENTHEM);
		quyens1.add(core().THUTIENSUA);
		quyens1.add(core().THUTIENXEM);
		quyens1.add(core().THUTIENLIST);
		quyens1.add(core().THUTIENXOA);
		
		quyens1.add(core().LYDOTHUXEM);
		quyens1.add(core().LYDOTHUSUA);
		quyens1.add(core().LYDOTHUXEM);
		quyens1.add(core().LYDOTHULIST);
		quyens1.add(core().LYDOTHUXOA);
		
		quyens1.add(core().THONGKEXEM);
		
		quyens1.add(core().PHIEUCHITHEM);
		quyens1.add(core().PHIEUCHISUA);
		quyens1.add(core().PHIEUCHIXEM);
		quyens1.add(core().PHIEUCHILIST);
		quyens1.add(core().PHIEUCHIXOA);
